...
1. Shared memory tiling for data locality
2. Coalesced global memory access patterns
3. Minimize bank conflicts in shared memory
4. Warp-level parallelism optimization
5. {constraints.get('additional_optimizations', 'Loop unrolling where beneficial')}
6. Efficient use of {constraints.get('registers', '32')} registers
